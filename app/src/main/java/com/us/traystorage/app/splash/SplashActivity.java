...
import com.us.traystorage.app.common.Common;
import com.us.traystorage.app.common.dialog.AlertDialog;
import com.us.traystorage.app.common.dialog.LoadingDialog;
import com.us.traystorage.app.common.util.Global;
import com.us.traystorage.app.common.util.PrefMgr;
import com.us.traystorage.app.setting.FaqActivity;
import com.us.traystorage.app.setting.InquiryActivity;
import com.us.traystorage.app.setting.NoticeActivity;
import com.us.traystorage.app.setting.SettingActivity;
import com.us.traystorage.app.setting.TermsActivity;
import com.us.traystorage.data.DataManager;
import com.us.traystorage.data.model.ModelUser;
import com.us.traystorage.databinding.ActivitySplashBinding;
...
public class SplashActivity extends BaseBindingActivity<ActivitySplashBinding> {
    ...
    void startApp() {
        ...
        int introShownVersion = prefMgr.getInt(PrefMgr.INTRO_SHOWN_VERSION, -1);
        if (introShownVersion < com.us.traystorage.BuildConfig.VERSION_CODE) {
