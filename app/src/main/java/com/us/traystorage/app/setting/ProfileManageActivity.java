...
import com.us.traystorage.databinding.ActivityProfileManageBinding;
...
public class ProfileManageActivity extends BaseBindingActivity<ActivityProfileManageBinding> {
    ...
    public void onClickBirthDay() {
        ...
        if(true){
            com.us.traystorage.app.common.dialog.DatePickerDialog.show(this).setDate(viewModel.birthday.getValue())
